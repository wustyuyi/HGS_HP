...
//-----24L01操作线-----//
#define NRF24L01_CE_H		GPIO_SetBits(GPIOA, GPIO_Pin_12) 					//24L01片选信号
#define NRF24L01_CE_L		GPIO_ResetBits(GPIOA, GPIO_Pin_12)
#define NRF24L01_CSN_H  GPIO_SetBits(GPIOA, GPIO_Pin_11) 					//SPI片选信号	 
#define NRF24L01_CSN_L	GPIO_ResetBits(GPIOA, GPIO_Pin_11)
...
extern u8 NRF24L01_TxPacket(u8 *txbuf,u8 len);														//发送一个包的数据
...
extern float nrf_soft_rssi;
extern uint8_t nrf_rc_update,nrf_sbus_update;
extern uint8_t nrf_soft_rssi_update;
