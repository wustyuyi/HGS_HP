...
#define LCD_DCout(data)		  GPIO_WriteBit(GPIOC,GPIO_Pin_15,data)//DC
#define LCD_RSTout(data)		GPIO_WriteBit(GPIOC,GPIO_Pin_14,data)//RES
#define LCD_SDAout(data)		GPIO_WriteBit(GPIOC,GPIO_Pin_13,data)//D1
#define LCD_SCLout(data)		GPIO_WriteBit(GPIOB,GPIO_Pin_9,data)//D0


#define READ_SDA   GPIO_ReadInputDataBit(GPIOC , GPIO_Pin_13)	//SDA 
#define IIC_SDA_H  GPIO_WriteBit(GPIOC,GPIO_Pin_13,Bit_SET)//D1
#define IIC_SDA_L  GPIO_WriteBit(GPIOC,GPIO_Pin_13,Bit_RESET)//D1
#define IIC_SCL_H  GPIO_WriteBit(GPIOB,GPIO_Pin_9,Bit_SET)//D0
#define IIC_SCL_L  GPIO_WriteBit(GPIOB,GPIO_Pin_9,Bit_RESET)//D0
