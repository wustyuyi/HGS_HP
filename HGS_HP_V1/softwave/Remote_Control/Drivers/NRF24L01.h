...
extern pair_data rc_pair;
extern float nrf_soft_rssi;

#define NRF_RX_BUFFER_SIZE 128
extern unsigned char NRF_Transparent_Data[NRF_RX_BUFFER_SIZE];
extern unsigned char NRF_Transparent_Update;
extern unsigned char NRF_Transparent_Cnt;
